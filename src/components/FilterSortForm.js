    ...
    <form className="filter-sort-form" onSubmit={(event) => { event.preventDefault(); }}>
      <div className="row row-search">
        <div className="form-group">
          ...
          <input type="text" name="searchValue" onChange={(event) => handleChange(event)} value={filterSortFormData.searchValue} placeholder="Find a book..." id="search-value" />
        </div>
      </div>
      <div className="row row-select">
        <div className="form-group">
          ...
          <div className="select-wrapper">
            <select name="filterReadValue" onChange={(event) => handleChange(event)} value={filterSortFormData.filterReadValue} id="filter-read-value">
        ...
        <div className="form-group">
          ...
          <div className="select-wrapper">
            <select name="sortValue" onChange={(event) => handleChange(event)} value={filterSortFormData.sortValue} id="sort-value">
